jQuery(document).ready(function ($) {
    ...
    //ADD OPTION WHEN CREATING NEW idea
    $('a#options-add').click(function (e) {
        e.preventDefault();
        var tr_id = parseInt($("tr.dragable:last").attr('id')) + 1;
        $("tr.dragable:last")
            .after("<tr class=\"dragable\" id=\"" + tr_id + "\"><td align=\"center\" ><b>" + tr_id + "</b></td><td><textarea class=\"inputbox checkit\" type=\"text\" name=\"ideaoption[]\" id=\"ideaoption" + tr_id + "\" rows=\"3\" style=\"width:90%;\" /><input type=\"hidden\" name=\"ordering[]\" id=\"ordering" + (tr_id - 1) + "\" value=\"" + (tr_id - 1) + "\" class=\"ordering\"></textarea></td><td></td></tr>");
    ...
    $('a#options-add-extra').click(function (e) {
        ...
        var tr_id = parseInt($("tr.dragable:last").attr('id')) + 1;
        $("tr.dragable:last")
            .after("<tr class=\"dragable\" id=\"" + tr_id + "\"><td align=\"center\" ><b>" + tr_id + "</b></td><td><textarea class=\"inputbox checkit\" type=\"text\" name=\"ideaoptionextra[]\" id=\"ideaoptionextra" + tr_id + "\" rows=\"3\" style=\"width:90%;\"></textarea><input type=\"hidden\" name=\"extra_ordering[]\" id=\"extra_ordering" + tr_id + "\" value=\"" + (tr_id - 1) + "\" class=\"ordering\" /></td><td><td></td></tr>");
        $("tr.dragable:last").hide();
        $("#reorder").tableDnDUpdate();
        $("tr.dragable:last").css({'backgroundColor': '#99cc00'})
            .fadeIn(400, function callback() {
        ...
        $("input[name^='ideaoptionextra']").focus();

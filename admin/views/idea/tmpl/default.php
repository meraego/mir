...
$doc->addScript('../media/mir/js/jquery.tablednd.js');
$doc->addScript('../media/mir/js/jquery.mir.js');
...
<form action="<?php echo JRoute::_('index.php?option=com_mir&controller=idea&layout=edit&id=' . (int) $row->id); ?>"
    ...
    <div class="span10">
        ...
        <ul class="nav nav-tabs">
            <li class="active">
                <a href="#details" data-toggle="tab"><?php echo JText::_('COM_MIR_DETAILS'); ?></a>
            </li>
            <li>
                <a href="#general" data-toggle="tab"><?php echo JText::_('COM_MIR_PARAMS_GENERAL'); ?></a>
            </li>
            <li>
                <a href="#results" data-toggle="tab"><?php echo JText::_('COM_MIR_RESULTS'); ?></a>
            </li>
        </ul>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane active" id="details">
                    ...
                    <div class="span8">
                        <div class="control-group">
                            <label class="control-label" for="title">
                                <?php echo JText::_('COM_MIR_TITLE'); ?>
                            </label>
                            <div class="controls">
                        ...
                        <div class="control-group">
                            <label class="control-label" for="alias">
                                <?php echo JText::_('COM_MIR_ALIAS'); ?>
                            </label>
                            <div class="controls">
                    ...
                    <div class="span4">
                        <div class="control-group">
                            <label class="control-label" for="lag">
                                <?php echo JText::_('COM_MIR_LAG'); ?>
                            </label>
                            <div class="controls">
                                <input class="span2" type="text" name="lag" id="lag"
                                       value="<?php echo $row->lag / 60; ?>">
                                <span class="help-inline muted"><?php echo JText::_('COM_MIR_HOURS_BETWEEN_VOTES'); ?></span>
                            </div>
                        </div>

                        <div class="control-group">
                            <label class="control-label" for="start">
                                <?php echo JText::_('COM_MIR_START_DATE'); ?><br>
                                <span class="muted"><?php echo JText::_('COM_MIR_START_DATE_DESC'); ?></span>
                            </label>
                            <div class="controls">
                                <?php
                        ...
                        <div class="control-group">
                            <label class="control-label" for="end">
                                <?php echo JText::_('COM_MIR_END_DATE'); ?><br>
                                <span class="muted"><?php echo JText::_('COM_MIR_END_DATE_DESC'); ?></span>
                            </label>
                            <div class="controls">
                                <?php
                        ...
                        <div class="control-group">
                            <label class="control-label">
                                <?php echo JText::_('COM_MIR_PUBLISHED'); ?>
                            </label>
                ...
                <fieldset class="adminform">
                    <legend><?php echo JText::_('COM_MIR_OPTIONS_DRAG_DROP'); ?></legend>
                    ...
                    <table class="admintable" id="reorder" style="width:90%;">
                        <tr style=" font-weight:bold;" class="nodrag">
                            <td style="width:40px;">
                                <a href="#" id="options-add<?php if($this->edit) echo '-extra'; ?>">
                                    <img src="../media/mir/images/idea-add.png"
                                         alt="<?php echo JText::_('COM_MIR_OPTION_ADD'); ?>""/>
                                </a>
                                <a href="#" id="options-remove<?php if($this->edit) echo '-extra'; ?>">
                                    <img src="../media/mir/images/idea-remove.png"
                                         alt="<?php echo JText::_('COM_MIR_OPTION_REMOVE'); ?>"/>
                                </a>
                            </td>
                            <td>
                                <b><?php echo JText::_('COM_MIR_OPTION'); ?></b>
                            </td>

                            <td>
                                <?php echo JText::_('COM_MIR_VOTES'); ?>
                            </td>
                        </tr>
                        <?php
                            ...
                            <tr class="dragable" id="<?php echo $i + 1; ?>">
                                ...
                                <td>
                                    <textarea class="inputbox checkit span10"
                                              type="text"
                                              name="ideaoption[<?php echo $this->options[$i]->id; ?>]"
                                              id="ideaoption<?php echo $this->options[$i]->id; ?>"
                        ...
                        { ?>
                            <tr class="dragable" id="<?php echo $i + 1; ?>">
                                ...
                                <td>
                                    <textarea class="inputbox checkit span10"
                                              type="text" name="ideaoption[]"
                                              id="ideaoption<?php echo $i + 1; ?>" rows="3"></textarea>
                ...
                { ?>
                    ...
                    <div id="options-reset-box">
                        <a href="#" id="options-reset" class="btn btn-warning">
                            <?php echo JText::_('COM_MIR_RESET_VOTES'); ?>
                        </a>
                        <span style="color:red; display:none;">
                            <?php echo JText::_('COM_MIR_RESET_VOTES_DESC'); ?>
                        </span>
                    </div>
                    <?php
                }

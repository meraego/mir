...
class plgSearchJUIdeisearch extends JPlugin
{
    ...
    function onContentSearch($text, $phrase = '', $ordering = '', $areas = null)
    {
        ...
        */
        ...
        {
            $rows[$key]->href = 'index.php?option=com_mir&amp;view=idea&amp;id=' . $row->id . ":" . $row->alias . self::getItemid($row->id);
        }
